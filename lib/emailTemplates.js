...
const ACCENT      = '#818cf8'; // indigo-400 (matches the portfolio dark theme)
...
const header = `
  background: linear-gradient(135deg, ${ACCENT_DARK} 0%, #ec4899 100%);
    ...
    <div style="${body}">
      ...
      <div style="text-align:center;">
        <a href="mailto:${email}?subject=Re: ${encodeURIComponent(subject || 'Your portfolio message')}"
           style="display:inline-block;background:linear-gradient(135deg,${ACCENT_DARK} 0%,#ec4899 100%);
